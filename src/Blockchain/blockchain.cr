...
module Blockchain
  class Blocked
    ...
    getter chain : Set(Blockchain::Block) #Array(String)#Blockchain::Block # Array.new of Int32 #Set(String)
    getter uncommitted_transactions : Set(Block::Transaction)#Array(String) #Block::Transaction
    getter nodes : Set(String)

    def initialize

      @chain = [Blockchain::Block.new].to_set #[Blockchain::Block.new.to_s]
      @uncommitted_transactions =  [Block::Transaction.new(from: "", to: "", amount: 0)].to_set #[Block::Transaction.new(from: "", to: "", amount: 0).to_s]
